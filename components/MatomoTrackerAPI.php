...
namespace Mercator\Matomo\Components;
...
class MatomoTrackerAPI extends ComponentBase {
     ...
     public function componentDetails()
     {
         ...
         return [
             'name'        => 'Matomo Tracker API ',
             'description' => "Code for customed Matomo website tracking.",
     ...
     public function onRun() {
       ...
       MatomoTracker::$URL = Settings::get('server');
       $matomoTracker = new MatomoTracker( Settings::get('site') );
       // $matomoTracker->doTrackPageView('MATOMO20220220-NOAUTH');
       $this->page['matomo'] = $matomoTracker;
     }
